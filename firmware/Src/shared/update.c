...
#else
  memcpy((uint8_t *)su, (uint8_t *)AQUA3_FLASH_UPDATE_START, sizeof(soft_update_t));
#endif
...
#else
    memcpy(cache, (uint8_t *)i, FLASH_PAGE_SIZE);
#endif
...
#else
    memcpy(cache, (uint8_t *)(AQUA3_FLASH_APP_START + i), FLASH_PAGE_SIZE);
#endif
