...
#define WATER7_PAR_LENGTH 240	  //	parameters array length (must be equal or bigger than sizeof(_AQUA_TAGS_TO_SAVE) / 4 and request length)
#define WATER7_PAR_COUNT 62		  //	parameters count (max 64)
...
#define WATER7_MAX_EVENT_COUNT 9
